...
// CRBW65API wrapper class

class CRBW65API : public COleDispatchDriver
{
public:
	CRBW65API(){} // Calls COleDispatchDriver default constructor
	CRBW65API(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CRBW65API(const CRBW65API& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	CString Get_TableCell_ST(long * table, long * row, long * col)
	{
		...
		InvokeHelper(0x60030006, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms, table, row, col);
		return result;
	}
	short Get_ToolName_C(LPCTSTR Value)
	{
		...
		InvokeHelper(0x60030007, DISPATCH_METHOD, VT_I2, (void*)&result, parms, Value);
		return result;
	}
	...
	short Get_TableCell(long * table, long * row, long * col, BSTR * Value)
	{
		...
		InvokeHelper(0x60030009, DISPATCH_METHOD, VT_I2, (void*)&result, parms, table, row, col, Value);
		return result;
	}
	long Set_PathPointCount(long * ct)
	{
		long result;
		static BYTE parms[] = VTS_PI4 ;
		InvokeHelper(0x6003000a, DISPATCH_METHOD, VT_I4, (void*)&result, parms, ct);
		return result;
	}
	short Set_TableCell(long * table, long * row, long * col, LPCTSTR Value)
	{
		...
		InvokeHelper(0x6003000b, DISPATCH_METHOD, VT_I2, (void*)&result, parms, table, row, col, Value);
		return result;
	}
	short Get_PointXYZ(long POINT, double * X, double * Y, double * z)
	{
		...
		InvokeHelper(0x6003000c, DISPATCH_METHOD, VT_I2, (void*)&result, parms, POINT, X, Y, z);
		return result;
	}
	short Get_Position(double * X, double * Y, double * z, double * Rx, double * Ry, double * Rz)
	{
		...
		InvokeHelper(0x6003000d, DISPATCH_METHOD, VT_I2, (void*)&result, parms, X, Y, z, Rx, Ry, Rz);
		return result;
	}
	short Get_PointData(long POINT, PointData * Data)
	{
		short result;
		static BYTE parms[] = VTS_I4 VTS_UNKNOWN ;
		InvokeHelper(0x6003000e, DISPATCH_METHOD, VT_I2, (void*)&result, parms, POINT, Data);
		return result;
	}
	long Set_PathPointData(short * PT, OrientationData * Dat)
	{
		...
		InvokeHelper(0x6003000f, DISPATCH_METHOD, VT_I4, (void*)&result, parms, PT, Dat);
		return result;
	}
	long Set_PathScript()
	{
		long result;
		InvokeHelper(0x60030010, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
	short Set_PointFull(long POINT, OrientationData * Dat)
	{
		short result;
		static BYTE parms[] = VTS_I4 VTS_UNKNOWN ;
		InvokeHelper(0x60030011, DISPATCH_METHOD, VT_I2, (void*)&result, parms, POINT, Dat);
		return result;
	}
	short Set_PointXYZ(long POINT, double X, double Y, double z)
	{
		...
		InvokeHelper(0x60030012, DISPATCH_METHOD, VT_I2, (void*)&result, parms, POINT, X, Y, z);
		return result;
	}
	short Exec_SimulationRun()
	{
		short result;
		InvokeHelper(0x60030013, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
		return result;
	}
	short Exec_GotoPoint(long POINT)
	{
		...
		InvokeHelper(0x60030014, DISPATCH_METHOD, VT_I2, (void*)&result, parms, POINT);
		return result;
	}
	short Get_ConvData(ConvData * Data)
	{
		...
		InvokeHelper(0x60030015, DISPATCH_METHOD, VT_I2, (void*)&result, parms, Data);
		return result;
	}
	short Get_JButtons(short * Dopt, BOOL * Dstt)
	{
		...
		InvokeHelper(0x60030016, DISPATCH_METHOD, VT_I2, (void*)&result, parms, Dopt, Dstt);
		return result;
	}
	VARIANT Get_PivotData(PivotData * Data)
	{
		VARIANT result;
		static BYTE parms[] = VTS_UNKNOWN ;
		InvokeHelper(0x60030017, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, Data);
		return result;
	}
	short Exec_Convert()
	{
